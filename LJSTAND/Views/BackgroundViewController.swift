...
class BackgroundViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let headerHeight = view.frame.height * 0.15
        ...
        serialButton.addTarget(self, action: #selector(BackgroundViewController.serialButtonPressed(_:)), for: UIControlEvents.touchUpInside)
        ...
        tsopButton.addTarget(self, action: #selector(BackgroundViewController.tsopButtonPressed(_:)), for: UIControlEvents.touchUpInside)
        ...
        lightButton.addTarget(self, action: #selector(BackgroundViewController.lightButtonPressed(_:)), for: UIControlEvents.touchUpInside)
        ...
        compassButton.addTarget(self, action: #selector(BackgroundViewController.compassButtonPressed(_:)), for: UIControlEvents.touchUpInside)
        ...
        settingsButton.addTarget(self, action: #selector(BackgroundViewController.settingsButtonPressed(_:)), for: UIControlEvents.touchUpInside)
