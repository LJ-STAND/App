...
/**
  A Material Design drop down in replacement for \code
  UIPickerView
  \endcode.
*/
...
/**
  The offset point relative to \code
  anchorView
  \endcode when the drop down is shown above the anchor view.
  By default, the drop down is showed onto the \code
  anchorView
  \endcode with the top
...
/**
  The offset point relative to \code
  anchorView
  \endcode when the drop down is shown below the anchor view.
  By default, the drop down is showed onto the \code
  anchorView
  \endcode with the top
  left corner for its origin, so an offset equal to (0, 0).
...
/**
  ...
  By default, the cell’s text takes the plain \code
  dataSource
  \endcode value.
  Changing \code
  cellConfiguration
  \endcode automatically reloads the drop down.
*/
...
/**
  ...
  Don’t forget to setup the \code
  dataSource
  \endcode,
  the \code
  anchorView
