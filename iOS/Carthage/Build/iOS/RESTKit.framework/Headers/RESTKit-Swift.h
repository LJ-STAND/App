...
@interface HTTP (SWIFT_EXTENSION(RESTKit)) <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
SWIFT_CLASS("_TtC7RESTKit10HTTPResult")
...
@interface NSNumber (SWIFT_EXTENSION(RESTKit))
@end


@interface NSURLResponse (SWIFT_EXTENSION(RESTKit))
@end
