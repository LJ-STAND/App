...
@property (nonatomic, readonly, copy) NSString * _Nullable _productIdentifier;
@end
...
@property (nonatomic, readonly, copy) NSArray<SKProduct *> * _Nullable _products;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable _invalidProductIdentifiers;
@end
